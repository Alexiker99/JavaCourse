...
public class Task_3 {
    ...
    @FunctionalInterface //  аналог делегитам, для использования лямбда-функций
    ...
    private static Operate GetOperation(String userInput, Scanner console) { // Присваиваем операцию
